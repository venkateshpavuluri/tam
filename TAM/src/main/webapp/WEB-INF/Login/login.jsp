...
<link rel="stylesheet"
	href="http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css"></link>
...
<body>
	<form action="home.mnt" method="post">
		<div id="header">
			...
			<div id="header-right">
				<p class="username">
					Welcome to <span class="color">TAM</span>
				</p>
		...
		<div id="login-block1">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<th width="288px"><span class="title">Login</span></th>
					<th width="84px" rowspan="2"><input type="submit"
						class="login-btn" value="<s:message code="label.login"/>" /></th>
				</tr>
				<tr>
					<td>
						<div class="usname">
							<label>User Name</label> <span class="txtbox"><input
								type="text" name="userName" tabindex="0" /></span>
						</div>
						<div class="password">
							<label>Password</label> <span class="txtbox"><input
								type="password" name="password" tabindex="1" /></span>
						</div> <!-- <div id="forgot">Forgot Password</div> -->
						<div>
							<a href="#" class="forgot" id="forgot"><s:message
		...
		<div id="dialog" title="Forgot Password">
			<form action="forgot.mnt" method="post">
				<table>
					<tr>
						<td>User Name</td>
						<td><input type="text" name="userNamefp" /></td>
					</tr>
					<tr>
						<td>Mail Id</td>
					...
					<tr>
						<td><input type="submit" value="Get Password" id="getpass" /></td>
					</tr>
				</table>
			</form>
		</div>
	...
	<div>
		<center>
			<h4 style="color: RED">
				<c:forEach var="invalidup" items="${invalidUserName}">
					<c:out value="${invalidup}"></c:out>
				</c:forEach>
			</h4>
		</center>
	...
	<div>
		<center>
			<h4 style="color: Green">
				<c:forEach var="validup" items="${validUsername}">
					<c:out value="${validup}"></c:out>
				</c:forEach>
			</h4>
		</center>
